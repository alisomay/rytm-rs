...
pub struct KitUnknown {
    ...
    pub __unknown_arr1b: [u8; 0x2], /* @0x002c..0x002d */
    pub __unknown_arr2: [u8; 0x4],  /* @0x07C6..0x07C9 */
    pub __unknown_arr4: [u8; 0x15], /* @0x0902..0x0916 */
    pub __unknown_pad37: u8,        /* @0x09D7 (scene_id MSB?) */
    // (note) 54 unknown bytes not present in v1 kit data
    pub __unknown_arr5: [u8; 54], /* @0x09D9..0x0A0E */
...
impl KitUnknown {
    pub fn apply_to_raw_kit(&self, raw_kit: &mut ar_kit_t) {
        ...
        raw_kit.__unknown_arr1b = self.__unknown_arr1b;
        raw_kit.__unknown_arr2 = self.__unknown_arr2;
        raw_kit.__unknown_arr4 = self.__unknown_arr4;
        raw_kit.__unknown_pad37 = self.__unknown_pad37;
        raw_kit.__unknown_arr5 = self.__unknown_arr5;
