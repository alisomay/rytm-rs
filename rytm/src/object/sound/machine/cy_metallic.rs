...
/// Parameters for the `CyMetallic` machine.
#[derive(Debug, Clone, Copy, PartialEq, PartialOrd)]
pub struct CyMetallicParameters {
    lev: u8,
    tun: i8,
    dec: u8,
    ton: i8,
...
impl From<&ar_sound_t> for CyMetallicParameters {
    fn from(raw_sound: &ar_sound_t) -> Self {
        unsafe {
            Self {
                ...
                trd: (from_s_u16_t(&raw_sound.synth_param_3) >> 8) as u8,
            }
        }
    }
}
